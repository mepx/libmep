...
//-----------------------------------------------------------------
void t_data::to_interval_everywhere(double min, double max)
{
    to_interval_all_variables(min, max);
	if (num_targets)
      to_interval_selected_col(min, max, num_cols - 1);
}
//-----------------------------------------------------------------
void t_data::to_interval_selected_col(double min, double max, int col)
{
    if (num_data)
		if (data_type == 0) {// double
...
//-----------------------------------------------------------------
void t_data::to_interval_all_variables(double min, double max)
{
	if (num_data)
		if (data_type == 0) {// double
			for (int v = 0; v < num_cols; v++) {
